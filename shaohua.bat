...
REM ÏµÍ³-¹ã¸æ-·Å¿ªÏµÍ³Ïû·ÑÕßÔÆ¹¦ÄÜ£¬¹Ø±ÕÔòÎÞ·¨µÇÂ¼ÕËºÅ,1ÊÇ½ûÓÃ£¬0ÊÇÆôÓÃ
...
REM ÏµÍ³-ÉèÖÃ-½ûÓÃÏµÍ³±ÀÀ£/ÖØÆôºó×Ô¶¯»Ö¸´Î´¹Ø±ÕµÄÓ¦ÓÃ
...
REM ÏµÍ³-ÉèÖÃ-¹Ø±Õ"ÖØÆôºóÊ¹ÓÃÎÒµÄµÇÂ¼ÐÅÏ¢×Ô¶¯»Ö¸´Ó¦ÓÃ"
...
REM ¼ÒÍ¥×éÕìÌý¡¢±¸·Ý·þÎñ¡¢WTG·þÎñ¡¢DMWÓÃ»§·þÎñ
...
REM ÏµÍ³-ÏµÍ³¸üÐÂ-win10½ûÖ¹¸üÐÂ´óÓÚ21H2°æ±¾
...
REM ÏµÍ³-°²È«ÉèÖÃ-¹Ø±Õ¸½¼þ°²È«±ê¼Ç£¬²»±£´æÇøÓòÀ´Ô´ÐÅÏ¢
reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\Policies\Attachments" /v "SaveZoneInformation" /t reg_dword /d 1 /f
reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\Policies\Attachments" /v "SaveZoneInformation" /t reg_dword /d 1 /f
REM ÏµÍ³-°²È«ÉèÖÃ-ËùÓÐºó×ºÖ±½ÓÏÂÔØ¡¢Ö±½Ó´ò¿ª
...
REM ½çÃæ-Ö÷ÌâÓë±³¾°-¹Ø±ÕÆ½»¬¹ö¶¯ÁÐ±í¿ò
reg add "HKCU\Control Panel\Desktop" /v "SmoothScroll" /t REG_DWORD /d 0 /f

REM ½çÃæ-×ÊÔ´¹ÜÀíÆ÷-ÅäÖÃµ±Ç°ÓÃ»§×ÀÃæÓÃ»§Ê×Ñ¡ÏîÑÚÂëÎª 0706ÊÇ9030078090000000ÉÏ´ÎÊÇ 9030078010000000£¨²»ÄÜ¶ÀÁ¢ÊäÈë·¨£© ÔÙÉÏ´ÎÊÇ 9032078010000000£¨ÏµÍ³Ä¬ÈÏÊÇ9012038010000000£©
...
REM Èí¼þ-Windows ÕÕÆ¬²é¿´Æ÷-ÉèÖÃÄ¬ÈÏ´ò¿ª·½Ê½
if exist "C:\Program Files\Imagine\Imagine64.exe" (
    echo.¼ì²âµ½ Imagine£¬ÉèÖÃÎªÄ¬ÈÏÍ¼Æ¬²é¿´Æ÷...
    ...
    echo.Ê¹ÓÃ SetUserFTA ÉèÖÃ Windows ÕÕÆ¬²é¿´Æ÷...
    for %%e in (jpg jpeg png bmp gif tif tiff ico webp) do (
    ...
    echo.Ê¹ÓÃ´«Í³·½·¨ÉèÖÃ Windows ÕÕÆ¬²é¿´Æ÷...
    for %%e in (.jpg .jpeg .png .bmp .gif .tif .tiff .ico .webp) do (
        reg add "HKLM\SOFTWARE\Microsoft\Windows Photo Viewer\Capabilities\FileAssociations" /v "%%e" /t REG_SZ /d "PhotoViewer.FileAssoc.Tiff" /f >nul 2>&1
...
REM Èí¼þ-·þÎñ-Asus-EDGE-¸£ê¿ÔÄ¶ÁÆ÷-WPS-chrome
(for %%s in (
AsusUpdateCheck
edgeupdatem
