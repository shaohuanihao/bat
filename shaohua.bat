...
REM ÏµÍ³-¹ã¸æ-½ûÓÃÊÇ0£¬»ù±¾ÊÇ1£¬Ò£²â¡£Êµ²â1¸üºÃ
...
REM ÏµÍ³-ÉèÖÃ-¿ªÆôÏµÍ³ÈÕÖ¾£¨by Windows 10ÓÅ»¯¸¨Öú¹¤¾ß£©
...
REM ÏµÍ³-ÐÔÄÜ-½ûÓÃNTFS×îºó·ÃÎÊ¸üÐÂÊ±¼ä
reg add "HKLM\SYSTEM\CurrentControlSet\Control\FileSystem" /v NtfsDisableLastAccessUpdate /t REG_DWORD /d 1 /f
REM ÏµÍ³-ÐÔÄÜ-ÓÃNTFSÎÄ¼þÏµÍ³µÄ"×îºó·ÃÎÊÊ±¼ä"¸üÐÂ¹¦ÄÜ
...
REM ÏµÍ³-Ô¶³Ì-ÔÊÐíÌí¼ÓÇý¶¯·Ç¹ÜÀíÔ±Éí·ÝÔËÐÐ
