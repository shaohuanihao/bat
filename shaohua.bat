...
REM ÏµÍ³-¹ã¸æ-¹Ø±ÕÏµÍ³ÍÆ¼öµÄÄÚÈÝ
reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "SubscribedContent-338389Enabled" /t reg_dword /d 0 /f
REM ÏµÍ³-¹ã¸æ-¹Ø±ÕÓÃ»§½çÃæÉÏµÄ½¨ÒéºÍ¹ã¸æ
reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "SubscribedContent-338393Enabled" /t reg_dword /d 0 /f
REM ÏµÍ³-¹ã¸æ-¹Ø±ÕÌØ¶¨ÀàÐÍµÄÏµÍ³½¨Òé»ò¹ã¸æ
reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "SubscribedContent-353694Enabled" /t reg_dword /d 0 /f
REM ÏµÍ³-¹ã¸æ-¹Ø±ÕÌØ¶¨µÄÏµÍ³½¨Òé»òÄÚÈÝÍÆ¼ö
reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "SubscribedContent-353696Enabled" /t reg_dword /d 0 /f
REM ÏµÍ³-¹ã¸æ-¹Ø±ÕÍÆ¼ö¡¢¹¦ÄÜÌáÊ¾
reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "SubscribedContent-353698Enabled" /t reg_dword /d 0 /f
REM ÏµÍ³-¹ã¸æ-¹Ø±ÕÏòµ¼ºÍÍÆ¼öÏà¹ØµÄÄÚÈÝ
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\CloudContent" /v "DisableSoftLanding" /t reg_dword /d 1 /f
REM ÏµÍ³-¹ã¸æ-½ûÓÃWindows¾Û¹âµÆ¹¦ÄÜ
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\CloudContent" /v "DisableWindowsSpotlightFeatures" /t reg_dword /d 1 /f
REM ÏµÍ³-¹ã¸æ-½ûÓÃWindowsµÄÏû·ÑÕß¹¦ÄÜ¼°ÔÚÏß·þÎñºÍ¹ã¸æ
...
REM ÏµÍ³-ÐÔÄÜ-Ê¹ÓÃÏµÍ³±äÁ¿»ñÈ¡ÏµÍ³ÅÌ·û
set "DriveLetter=%SystemDrive:~0,1%"
REM ÏµÍ³-ÐÔÄÜ-Ê¹ÓÃPowerShell¼ì²âÇý¶¯Æ÷ÀàÐÍ
for /f "delims=" %%i in ('powershell -command "Get-PhysicalDisk | Where-Object {$_.DeviceId -eq (Get-Partition -DriveLetter '%DriveLetter%').DiskNumber} | Select-Object MediaType -ExpandProperty MediaType" 2^>nul') do set "DriveType=%%i"
REM ÏµÍ³-ÐÔÄÜ-ÅÐ¶ÏÊÇ·ñÎªSSD²¢Ö´ÐÐÓÅ»¯
if "!DriveType!"=="SSD" (
REM ÏµÍ³-ÐÔÄÜ-½ûÓÃ´ÅÅÌËéÆ¬ÕûÀí¼Æ»®ÈÎÎñ
    schtasks /change /tn "Microsoft\Windows\Defrag\ScheduledDefrag" /disable
REM ÏµÍ³-ÐÔÄÜ-½ûÓÃ SuperFetch / SysMain
    reg add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management\PrefetchParameters" /v EnableSuperfetch /t reg_dword /d 0 /f
REM ÏµÍ³-ÐÔÄÜ-½ûÓÃÒ³ÃæÎÄ¼þ
    reg add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" /v DisablePagingExecutive /t reg_dword /d 1 /f
)

REM ÏµÍ³-·þÎñ-½ûÓÃWindows DefenderµÄ6¸ö·þÎñ£¨Sense/WdBoot/WdFilter/WdNisDrv/WdNisSvc/WinDefend£©
...
REM ÏµÍ³-°²È«ÉèÖÃ-½ûÓÃ¹Ø»úÊÂ¼þ¸ú×ÙÆ÷
...
REM ½çÃæ-¿ªÊ¼²Ëµ¥-½ûÓÃ¿ªÊ¼²Ëµ¥µÄÓ¦ÓÃÍÆ¼ö´ÅÌù
